...
// Add `avatar: "/images/avatar/xyz.jpg"` for a real channel profile picture
// (falls back to a letter circle if omitted).
...
const portfolioItems = [
  ...
  { niche: "irl", image: "/images/IRL/01_men.png", avatar: "/images/avatar/vjwn.jpg", title: "Nepal 2026: How Kathmandu has changed after the tragedy", channel: "Viajenturas" },
...
if (hireForm) {
  hireForm.addEventListener("submit", async e => {
    ...
    if (hireForm.action.includes("YOUR_FORM_ID")) {
      status.textContent = "Form isn't connected yet — add your Formspree ID in the code.";
      return;
    }
